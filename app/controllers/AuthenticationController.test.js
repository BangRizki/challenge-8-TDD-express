...
describe("AuthenticationController", () => {
    describe("instantiate AuthenticationController", () => {
        it("should be defined", () => {
            const name = "kiki";
            const email = "kikikiki@gmail.com";
            const image = "kiki.jpeg";
    ...
    describe("authorize", () => {
        it("should return a 401 error when token is not provided", () => {
            const roleName = "ADMIN";
            const mockRole = new Role({ name: roleName });
        ...
        it("should return a 401 error when token is malformed", () => {
            const roleName = "ADMIN";
            const mockRole = new Role({ name: roleName });
        ...
        it("should return a 401 error when token is invalid", () => {
        ...
        it("should return 401 when token role is not same with the required role", () => {
            const roleName = "CUSTOMER";
            const mockRole = new Role({ id: 1, name: roleName });
        ...
        it("should return next when token role is same with the required role", () => {
            const roleName = "CUSTOMER";
            const mockRole = new Role({ id: 1, name: roleName });
    ...
    describe("handleLogin", () => {
        ...
        it("should return a 201 status and a token when password is correct", async () => {
            const roleName = "ADMIN";
    ...
    describe("handleRegister", () => {
        it("should return a 422 error when email is already registered", async () => {
            const mockUser = new User({
                id: 1,
                name: "kiki",
                email: "kiki@gmail.com",
        ...
        it("should return next whenre's rejected promise", async () => {
            const mockUserModel = {
                findOne: jest.fn(() => Promise.reject(err)),
            };
    ...
    describe("handleGetUser", () => {
        ...
        it("should return a 404 status when role is not found", async () => {
            const roleName = "CUSTOMER";
            const mockRole = new Role({ id: 1, name: roleName });
